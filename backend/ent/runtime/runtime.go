...
func init() {
	...
	// announcementDescPublicVisible is the schema descriptor for public_visible field.
	announcementDescPublicVisible := announcementFields[4].Descriptor()
	// announcement.DefaultPublicVisible holds the default value on creation for the public_visible field.
	announcement.DefaultPublicVisible = announcementDescPublicVisible.Default.(bool)
