export default {
    ...
    redeem: {
      ...
      benefitHint: 'These codes share one batch. Each user can redeem only one code from this batch.',
    ...
    announcements: {
      ...
      form: {
        ...
        publicVisible: 'Show on public website',
        publicVisibleHint: 'Only active announcements within their schedule appear on the public website. Do not include information intended only for signed-in users.',
        startsAt: 'Starts At',
        endsAt: 'Ends At',
      ...
      publicVisibleOn: 'Public website',
      publicVisibleOff: 'Console only',
