export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for 零一 API user sign-in',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for 零一 API user sign-in',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: '零一 API',
        siteNameHint: 'Displayed in emails and page titles',
        siteSubtitle: 'Site Subtitle',
        siteSubtitlePlaceholder: '从零到一，连接每一次模型调用。',
        siteSubtitleHint: 'Displayed on login and register pages',
        landingNotice: {
          title: 'Landing Page Notice',
          description: 'Configure the optional notice bar shown at the top of the public landing page.',
          enabled: 'Show Landing Page Notice',
          enabledHint: 'When disabled, the public landing page hides the notice while preserving its text and link.',
          text: 'Notice Text',
          textPlaceholder: 'Enter a short landing page notice',
          textHint: 'Up to 160 characters. Keep it concise and avoid time-sensitive claims that cannot be verified continuously.',
          url: 'Notice Link',
          urlPlaceholder: '/keys',
          urlHint: 'Optional. Use a site path such as /keys or an absolute http(s) URL. Invalid links hide only the link.',
          urlInvalid: 'Invalid link. Use a site path such as /keys or an absolute http(s) URL; saving will hide only the link.',
        },
