export default {
  ...
  redeem: {
    title: 'Redeem Code',
    description: 'Enter a code to claim balance, benefits, mystery-box credit, or concurrency',
    ...
    codeRule1: 'Each code can be used once; benefit and mystery-box batches also allow one claim per user',
    codeRule2: 'Codes may add balance, benefit credit, random mystery-box credit, concurrency, or trial access',
    ...
    benefitAddedRedeem: 'Benefit Credit (Redeem)',
    mysteryBoxAddedRedeem: 'Mystery Box Credit (Redeem)',
    batchAlreadyClaimed: 'You have already claimed a code from this benefit batch.',
