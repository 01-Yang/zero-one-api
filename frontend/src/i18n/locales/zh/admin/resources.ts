export default {
    ...
    redeem: {
      ...
      benefitHint: '本次生成的兑换码属于同一批次；同一用户在该批次中只能成功兑换一张。',
      mysteryBoxHint: '用户首次兑换时将在设定范围内随机获得额度；同一用户在该批次中只能成功兑换一张。',
      minAmount: '最低额度 ($)',
      maxAmount: '最高额度 ($)',
      invalidMysteryBoxRange: '盲盒额度范围无效，最高额度必须大于或等于最低额度。',
      oneTimeCodeWarning: '卡密明文只显示这一次。关闭后后台仅保留不可兑换的脱敏标识，请立即复制或下载并妥善保管。',
      allTypes: '全部类型',
      allStatus: '全部状态',
      unused: '未使用',
      used: '已使用',
    ...
    announcements: {
      ...
      form: {
        ...
        publicVisible: '官网公开',
        publicVisibleHint: '仅把处于“展示中”且在有效期内的公告公开到官网。请勿包含仅面向登录用户的信息。',
        startsAt: '开始时间',
        endsAt: '结束时间',
      ...
      publicVisibleOn: '官网公开',
      publicVisibleOff: '仅系统内',
      timeImmediate: '立即',
      timeNever: '永久',
      readStatus: '已读情况',
      preview: '预览',
