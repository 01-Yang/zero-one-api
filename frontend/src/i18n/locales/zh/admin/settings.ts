    ...
    settings: {
      ...
      features: {
        channelMonitor: {
          ...
          publicStatusEnabled: '公开匿名状态摘要',
          publicStatusEnabledHint: '允许官网访客无需登录读取聚合状态。默认关闭；关闭后立即绕过已有摘要。',
          mode: '监控模式',
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于零一 API 用户登录',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于零一 API 用户登录',
      ...
      site: {
        ...
        landingNotice: {
          title: '首页公告条',
          description: '配置公开首页顶部的可选公告条。',
          enabled: '显示首页公告',
          enabledHint: '关闭后公开首页不展示公告条，文案和链接配置仍会保留。',
          text: '公告正文',
          textPlaceholder: '请输入简短的首页公告',
          textHint: '最多 160 个字符。建议保持简短，并避免无法长期核实的时效性承诺。',
          url: '跳转链接',
          urlPlaceholder: '/keys',
          urlHint: '可选。支持 /keys 等站内路径或完整的 http(s) URL；非法链接只隐藏跳转，不影响正文。',
          urlInvalid: '链接格式无效。请输入 /keys 等站内路径或完整的 http(s) URL；保存时会仅隐藏跳转。',
        },
        apiBaseUrl: 'API 端点地址',
