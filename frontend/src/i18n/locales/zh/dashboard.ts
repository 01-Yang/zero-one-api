export default {
  ...
  redeem: {
    title: '兑换码',
    description: '输入兑换码以领取余额、福利、盲盒额度或增加并发数',
    currentBalance: '当前余额',
    concurrency: '并发数',
    requests: '请求',
    redeemCodeLabel: '兑换码',
    ...
    newConcurrency: '新并发数',
    aboutCodes: '关于兑换码',
    codeRule1: '每个兑换码只能使用一次；批次福利码和盲盒码还限制每位用户每批次领取一次',
    codeRule2: '兑换码可以增加余额、福利额度、随机盲盒额度、并发数或试用权限',
    codeRule3: '如有兑换问题，请联系客服',
    codeRule4: '余额和并发数即时更新',
    recentActivity: '最近活动',
    historyWillAppear: '您的兑换历史将显示在这里',
    balanceAddedRedeem: '余额充值（兑换）',
    benefitAddedRedeem: '福利额度（兑换）',
    mysteryBoxAddedRedeem: '盲盒额度（兑换）',
    batchAlreadyClaimed: '你已经领取过这一批福利，不能再兑换该批次中的其他卡密。',
