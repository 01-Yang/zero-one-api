...
const BADGE: Record<Platform, string> = {
  anthropic: 'bg-zo-alert-500/10 text-zo-alert-600 border-zo-alert-500/30 dark:text-zo-alert-400',
  openai: 'bg-zo-signal-500/10 text-zo-signal-600 border-zo-signal-500/30 dark:text-zo-signal-400',
...
const BORDER: Record<Platform, string> = {
  anthropic: 'border-zo-alert-500/20 dark:border-zo-alert-500/20',
  openai: 'border-zo-signal-500/20 dark:border-zo-signal-500/20',
...
const BORDER_STRONG: Record<Platform, string> = {
  anthropic: 'border-zo-alert-500/35 dark:border-zo-alert-500/30',
  openai: 'border-zo-signal-500/35 dark:border-zo-signal-500/30',
...
const ACCENT_DEFAULT = '#7c5cfc' // primary-500 (indigo-violet)

// ── Accent bar (solid platform marker) ─────────────────────────────
const ACCENT_BAR: Record<Platform, string> = {
  anthropic: 'bg-zo-alert-500',
  openai: 'bg-zo-signal-500',
...
const ICON: Record<Platform, string> = {
  anthropic: 'text-zo-alert-500 dark:text-zo-alert-400',
  openai: 'text-zo-signal-500 dark:text-zo-signal-400',
...
const BUTTON: Record<Platform, string> = {
  anthropic: 'bg-zo-alert-500 text-white hover:bg-zo-alert-600 active:bg-zo-alert-700 dark:bg-zo-alert-500/80 dark:hover:bg-zo-alert-500',
  openai: 'bg-zo-signal-600 text-white hover:bg-zo-signal-700 active:bg-zo-signal-800 dark:bg-zo-signal-600/80 dark:hover:bg-zo-signal-600',
...
const DISCOUNT: Record<Platform, string> = {
  anthropic: 'bg-zo-alert-100 text-zo-alert-700 dark:bg-zo-alert-900/40 dark:text-zo-alert-300',
  openai: 'bg-zo-signal-100 text-zo-signal-700 dark:bg-zo-signal-900/40 dark:text-zo-signal-300',
...
const GRADIENT: Record<Platform, string> = {
  anthropic: 'from-zo-alert-500 to-zo-alert-600',
  openai: 'from-zo-signal-500 to-zo-signal-600',
...
const GRADIENT_TEXT: Record<Platform, string> = {
  anthropic: 'text-zo-alert-100',
  openai: 'text-zo-signal-100',
...
const GRADIENT_SUBTEXT: Record<Platform, string> = {
  anthropic: 'text-zo-alert-200',
  openai: 'text-zo-signal-200',
