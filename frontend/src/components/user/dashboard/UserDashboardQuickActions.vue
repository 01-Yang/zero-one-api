<template>
  <div class="card">
    ...
    <div class="space-y-3 p-4">
      <button @click="router.push('/keys')" class="group flex w-full items-center gap-4 rounded-lg bg-gray-50 p-4 text-left transition-colors duration-200 hover:bg-gray-100 dark:bg-dark-800/50 dark:hover:bg-dark-800">
        <div class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg bg-gray-100 dark:bg-dark-700">
          <Icon name="key" size="lg" class="text-gray-700 dark:text-gray-200" />
        </div>
      ...
      <button @click="router.push('/usage')" class="group flex w-full items-center gap-4 rounded-lg bg-gray-50 p-4 text-left transition-colors duration-200 hover:bg-gray-100 dark:bg-dark-800/50 dark:hover:bg-dark-800">
        <div class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg bg-gray-100 dark:bg-dark-700">
          <Icon name="chart" size="lg" class="text-gray-700 dark:text-gray-200" />
        </div>
        <div class="min-w-0 flex-1">
      ...
      <button v-if="canUseBatchImage" @click="router.push('/batch-image')" class="group flex w-full items-center gap-4 rounded-lg bg-gray-50 p-4 text-left transition-colors duration-200 hover:bg-gray-100 dark:bg-dark-800/50 dark:hover:bg-dark-800">
        <div class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg bg-gray-100 dark:bg-dark-700">
          <Icon name="sparkles" size="lg" class="text-gray-700 dark:text-gray-200" />
        </div>
        <div class="min-w-0 flex-1">
