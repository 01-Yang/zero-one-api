            ...
            <table class="w-full text-xs">
              ...
              <tbody>
                <tr v-for="model in models" :key="model.model" class="border-t border-gray-100 dark:border-dark-700">
                  ...
                  <td class="py-1.5 text-right text-zo-signal-600 dark:text-zo-signal-400">${{ formatCost(model.actual_cost) }}</td>
...
const modelData = computed(() => !props.models?.length ? null : {
  ...
  datasets: [{
    ...
    backgroundColor: ['#3b82f6', '#7c5cfc', '#a855f7', '#ef4444', '#8b5cf6', '#ec4899', '#06b6d4', '#93c5fd']
  }]
})
