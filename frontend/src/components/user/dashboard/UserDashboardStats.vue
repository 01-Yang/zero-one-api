    ...
    <div v-if="!isSimple" class="card p-4">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-bold text-gray-900 dark:text-white">${{ formatBalance(balance) }}</p>
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-bold text-gray-900 dark:text-white">
            <span class="text-gray-900 dark:text-white" :title="t('dashboard.actual')">${{ formatCost(stats?.today_actual_cost || 0) }}</span>
          ...
          <p class="text-xs">
            ...
            <span class="text-gray-700 dark:text-gray-200" :title="t('dashboard.actual')">${{ formatCost(stats?.total_actual_cost || 0) }}</span>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        ...
        <div class="flex-1">
          ...
          <div class="flex items-baseline gap-2">
            <p class="text-sm font-semibold text-gray-700 dark:text-gray-200">{{ formatTokens(stats?.tpm || 0) }}</p>
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <span class="font-mono text-sm text-gray-900 dark:text-white" :title="t('dashboard.actual')">
