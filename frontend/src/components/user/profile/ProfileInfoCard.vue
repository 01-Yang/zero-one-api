<template>
  <div class="space-y-6">
    <section
      ...
      class="card overflow-hidden border border-gray-200 bg-white dark:border-dark-700 dark:bg-dark-800"
    >
      <div class="px-6 py-6 md:px-8">
        <div class="flex flex-col gap-6 lg:flex-row lg:items-start">
          <div
            class="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-gray-900 text-2xl font-bold text-white dark:bg-white dark:text-dark-950"
          >
            <img
              v-if="avatarUrl"
              :src="avatarUrl"
          ...
          <div class="min-w-0 flex-1 space-y-5">
              ...
              <div class="space-y-1">
                ...
                >
                  <span
                    ...
                    :key="hint.key"
                    class="inline-flex items-center gap-1 rounded-full bg-gray-100 px-3 py-1 dark:bg-dark-700"
                  >
            ...
            <div class="grid gap-3 sm:grid-cols-3">
              <div
                ...
                class="border-t border-gray-200 px-4 py-3 dark:border-dark-700"
              >
    ...
    <div class="space-y-6">
      <div data-testid="profile-main-column" class="space-y-6">
        <section
          ...
          class="card border border-gray-200 bg-white p-6 dark:border-dark-700 dark:bg-dark-800"
        >
          ...
          <div class="grid gap-6 sm:grid-cols-1 md:grid-cols-2">
            <div class="rounded-lg border border-gray-200 bg-gray-50 p-5 dark:border-dark-700 dark:bg-dark-900">
              <ProfileAvatarCard
                :user="user"
                embedded
              />
        ...
        >
          ...
          <div class="mt-5 grid gap-3">
            <div
              v-for="hint in sourceHints"
              :key="hint.key"
              class="flex items-start gap-3 rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-600 dark:border-dark-700 dark:bg-dark-900 dark:text-gray-300"
            >
