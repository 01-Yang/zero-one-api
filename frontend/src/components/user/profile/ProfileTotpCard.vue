    ...
    <div class="px-6 py-6">
      ...
      <div v-else-if="status?.enabled" class="flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex-shrink-0 rounded-full bg-zo-signal-100 p-3 dark:bg-zo-signal-900/30">
            <svg class="h-6 w-6 text-zo-signal-600 dark:text-zo-signal-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
