      ...
      <template v-else-if="stats">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          <div class="card p-4">
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="rounded-lg bg-gray-100 p-1.5 dark:bg-dark-700">
                <Icon name="bolt" size="sm" class="text-gray-700 dark:text-gray-200" :stroke-width="2" />
              </div>
            </div>
            <p class="text-2xl font-bold text-gray-900 dark:text-white">
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-gray-100 p-1.5 dark:bg-dark-700">
                <Icon name="cube" size="sm" class="text-gray-700 dark:text-gray-200" :stroke-width="2" />
              </div>
              <span class="text-sm font-semibold text-gray-900 dark:text-white">{{
