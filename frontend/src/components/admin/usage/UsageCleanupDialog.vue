<template>
  <BaseDialog :show="show" :title="t('admin.usage.cleanup.title')" width="wide" @close="handleClose">
    <div class="space-y-4">
      ...
      <div class="rounded-xl border border-zo-alert-200 bg-zo-alert-50 px-4 py-3 text-sm text-zo-alert-700 dark:border-zo-alert-500/30 dark:bg-zo-alert-500/10 dark:text-zo-alert-200">
...
const statusClass = (status: string) => {
  const map: Record<string, string> = {
    pending: 'bg-zo-alert-100 text-zo-alert-700 dark:bg-zo-alert-500/20 dark:text-zo-alert-200',
    running: 'bg-blue-100 text-blue-700 dark:bg-blue-500/20 dark:text-blue-200',
    succeeded: 'bg-zo-signal-100 text-zo-signal-700 dark:bg-zo-signal-500/20 dark:text-zo-signal-200',
