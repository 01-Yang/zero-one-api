<template>
  <div class="space-y-4">
    ...
    <template v-if="outcome === 'success'">
      <div class="card p-6">
        <div class="flex flex-col items-center space-y-4 py-4">
          <div class="flex h-16 w-16 items-center justify-center rounded-full bg-zo-signal-100 dark:bg-zo-signal-900/30">
            <Icon name="check" size="lg" class="text-zo-signal-500" />
          </div>
    ...
    <template v-else-if="outcome === 'expired'">
      <div class="card p-6">
        <div class="flex flex-col items-center space-y-4 py-4">
          <div class="flex h-16 w-16 items-center justify-center rounded-full bg-zo-alert-100 dark:bg-zo-alert-900/30">
            <svg class="h-8 w-8 text-zo-alert-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
const qrBorderClass = computed(() => {
  ...
  if (isWxpay.value) return 'border-[#2BB741] bg-zo-signal-50 dark:border-[#2BB741]/70 dark:bg-zo-signal-950/20'
