...
function methodSelectedClass(type: string): string {
  ...
  if (isBuiltInWxpayMethod(type)) return 'border-[#09BB07] bg-zo-signal-50 text-gray-900 shadow-sm dark:bg-zo-signal-950 dark:text-gray-100'
  if (type === 'stripe') return 'border-[#676BE5] bg-indigo-50 text-gray-900 shadow-sm dark:bg-indigo-950 dark:text-gray-100'
  if (type === 'airwallex') return 'border-[#FF6B3D] bg-zo-alert-50 text-gray-900 shadow-sm dark:border-[#FF8E3C] dark:bg-zo-alert-950 dark:text-gray-100'
