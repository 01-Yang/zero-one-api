  ...
  <header class="sticky top-0 z-30 border-b border-gray-200 bg-white dark:border-dark-800 dark:bg-dark-950">
    <div class="flex h-16 items-center justify-between gap-2 px-2 sm:px-4 md:px-6">
      ...
      <div class="flex min-w-0 items-center gap-1 sm:gap-3">
        ...
        <div
          v-if="user"
          class="group relative hidden items-center gap-2 rounded-lg bg-gray-100 px-3 py-1.5 dark:bg-dark-800 sm:flex"
        >
          <svg
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          <button
            ...
            class="flex items-center gap-2 rounded-lg p-1.5 transition-colors duration-200 hover:bg-gray-100 dark:hover:bg-dark-800"
            :aria-label="t('common.userMenu')"
          >
            <div class="flex h-8 w-8 items-center justify-center overflow-hidden rounded-lg bg-gray-900 text-sm font-medium text-white dark:bg-white dark:text-dark-950">
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
                :alt="displayName"
