      ...
      <template v-else-if="detail">
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div class="card p-5">
            ...
            <p class="mt-2 text-2xl font-semibold text-zo-signal-600 dark:text-zo-signal-400">
          ...
          <div class="card p-5">
            ...
            <p v-if="detail.aff_frozen_quota > 0" class="mt-1 text-xs text-zo-alert-600 dark:text-zo-alert-400">
        ...
        <div class="card p-6">
          ...
          <p v-if="detail.aff_quota <= 0" class="mt-3 text-sm text-zo-alert-600 dark:text-zo-alert-400">
            ...
            <table class="w-full min-w-[560px] text-left text-sm">
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="px-3 py-3 text-right font-medium text-zo-signal-600 dark:text-zo-signal-400">{{ formatCurrency(item.total_rebate) }}</td>
