        ...
        <div class="relative z-10 w-full max-w-lg rounded-xl bg-white shadow-xl dark:bg-dark-800">
          ...
          >
            <div class="flex items-center gap-3">
              <div
                class="flex h-10 w-10 items-center justify-center rounded-full bg-zo-signal-100 dark:bg-zo-signal-900/30"
              >
                <svg
                  class="h-5 w-5 text-zo-signal-600 dark:text-zo-signal-400"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
