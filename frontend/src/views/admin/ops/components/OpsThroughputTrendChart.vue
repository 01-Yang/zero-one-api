  ...
  return {
    ...
    datasets: [
      ...
      },
      {
        ...
        borderColor: colors.value.violet,
        backgroundColor: colors.value.violetAlpha,
        fill: true,
        tension: 0.4,
        pointRadius: 0,
        pointHitRadius: 10,
  ...
  <div class="flex h-full min-w-0 flex-col rounded-3xl bg-white p-6 shadow-sm ring-1 ring-gray-900/5 dark:bg-dark-800 dark:ring-dark-700">
    ...
    >
      ...
      >
        ...
        <span class="flex shrink-0 items-center gap-1"><span class="h-2 w-2 rounded-full bg-zo-signal-500"></span>{{ t('admin.ops.tpsK') }}</span>
