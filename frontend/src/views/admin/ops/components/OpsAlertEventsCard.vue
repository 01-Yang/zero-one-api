...
function severityBadgeClass(severity: string | undefined): string {
  ...
  if (s === 'p1' || s === 'warning') return 'bg-zo-alert-100 text-zo-alert-700 dark:bg-zo-alert-900/30 dark:text-zo-alert-300'
...
function statusBadgeClass(status: string | undefined): string {
  ...
  if (s === 'resolved') return 'bg-zo-signal-50 text-zo-signal-700 ring-zo-signal-600/20 dark:bg-zo-signal-900/30 dark:text-zo-signal-300 dark:ring-zo-signal-500/30'
