      ...
      <div v-else class="space-y-3">
        ...
        >
          <div class="flex items-center gap-3">
            <div class="flex h-8 w-8 items-center justify-center rounded-full bg-zo-signal-100 dark:bg-zo-signal-900/30">
              <Icon name="user" size="sm" class="text-zo-signal-600 dark:text-zo-signal-400" />
            </div>
            <div>
          ...
          <div class="text-right">
            <span class="text-sm font-medium text-zo-signal-600 dark:text-zo-signal-400">
