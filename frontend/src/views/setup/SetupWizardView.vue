<template>
  <div
    class="flex min-h-screen items-center justify-center bg-gray-50 p-4 text-gray-900 dark:bg-dark-950 dark:text-white"
  >
    <div class="w-full max-w-2xl">
      <!-- Logo & Title -->
      <div class="mb-8 text-center">
        <div
          class="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-lg bg-gray-900 text-white dark:bg-white dark:text-dark-950"
        >
        ...
        <div class="flex items-center justify-center">
          <template v-for="(step, index) in steps" :key="step.id">
              ...
              <div
                :class="[
                  ...
                  currentStep > index
                    ...
                    : currentStep === index
                      ? 'bg-gray-900 text-white ring-4 ring-gray-200 dark:bg-white dark:text-dark-950 dark:ring-dark-700'
            ...
            <div
              ...
              :class="currentStep > index ? 'bg-gray-900 dark:bg-white' : 'bg-gray-200 dark:bg-dark-700'"
            ></div>
          </template>
        </div>
      </div>
      ...
      <!-- Step Content -->
      <div class="rounded-lg border border-gray-200 bg-white p-8 shadow-card dark:border-dark-700 dark:bg-dark-800">
        <!-- Step 1: Database -->
        <div v-if="currentStep === 0" class="space-y-6">
          ...
          >
            ...
            <Icon v-else-if="dbConnected" name="check" size="md" class="mr-2 text-zo-signal-500" :stroke-width="2" />
            {{
              testingDb
        ...
        <div
          v-if="installSuccess"
          class="mt-6 rounded-lg border border-zo-signal-200 bg-zo-signal-50 p-4 dark:border-zo-signal-800/50 dark:bg-zo-signal-900/20"
        >
          <div class="flex items-start gap-3">
            <svg
              v-if="!serviceReady"
              class="h-5 w-5 flex-shrink-0 animate-spin text-zo-signal-500"
              fill="none"
              viewBox="0 0 24 24"
            >
              <circle
            ...
            <Icon v-else name="checkCircle" size="md" class="flex-shrink-0 text-zo-signal-500" />
            <div>
              <p class="text-sm font-medium text-zo-signal-700 dark:text-zo-signal-400">
                {{ t('setup.status.completed') }}
              </p>
              <p class="mt-1 text-sm text-zo-signal-600 dark:text-zo-signal-500">
                {{
                  serviceReady
